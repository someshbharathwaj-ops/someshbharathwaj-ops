...
CS student, dual-degree — B.Tech CSE at Amrita and BS Data Science & AI at IIT Madras. Work sits at the intersection of **retrieval systems**, **applied ML**, and **algorithmic thinking**. I build things that actually work — clean architecture, measurable behavior, fundamentals first.
...
**RAG System — Evolab**
Refining chunking, indexing, and evaluation logic for a production retrieval pipeline.

**RFID Accountability System** *(long-term)*
AI + embedded systems for institutional accountability. Designed from the ground up.
...
<td>Full RAG pipeline with custom evaluation logic. Actively improving retrieval precision and generation quality.</td>
...
<td>AI + embedded systems for real-world institutional tracking infrastructure.</td>
...
<details>
<summary><b>Coursework & Active Study Areas</b></summary>
<br/>
...
**Active focus:** Retrieval systems · Embedding models · Dense vs sparse retrieval · ML optimization · Graph algorithms · Systems design for reliability
...
```
Short-term   →   Complete RAG system at Evolab with solid evaluation coverage
